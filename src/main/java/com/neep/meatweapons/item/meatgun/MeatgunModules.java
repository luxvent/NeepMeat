...
public class MeatgunModules
{
    ...
    public static final MeatgunModule.Type<?> BASE = register(new Identifier(MeatWeapons.NAMESPACE, "base"), p -> new BaseModule());
    public static final MeatgunModule.Type<?> CHUGGER = register(new Identifier(MeatWeapons.NAMESPACE, "chugger"), p -> new ChuggerModule());
