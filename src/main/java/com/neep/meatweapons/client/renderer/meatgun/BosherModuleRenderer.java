...
public class BosherModuleRenderer implements MeatgunModuleRenderer<BosherModule>
{
    ...
    @Override
    public void render(ItemStack stack, MeatgunComponent component, BosherModule module, ModelTransformationMode mode, MatrixStack matrices, VertexConsumerProvider vertexConsumers, long time, float tickDelta, int light, int overlay)
    {
